...
//OPEN  
 ...
 Load_Publications("ME"); 
   ...
   public void Retour_Show(ActionEvent e)
    {
                 try {       
              profile = FXMLLoader.load(getClass().getResource("../../utilisateur/GUI/UIuser/UIuser.fxml"));
            } catch (IOException ex) {
                Logger.getLogger(CollabwController.class.getName()).log(Level.SEVERE, null, ex);
            }
             Scene scene = new Scene(profile);      
            Stage CStage = (Stage) (((Node) e.getSource()) .getScene().getWindow());
            CStage.hide();
            ...
            public void handle(MouseEvent event) {
                ...
                yOffset = event.getSceneY();
                  ...
                  profile.setOnMouseDragged(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
